...
class TwitterScreen extends StatefulWidget {
  ...
  TwitterScreen(this.currentUri, this.currentPageUrl, {Key? key}) : super(key: key);

  @override
  State<TwitterScreen> createState() => _TwitterScreenState();
}

class _TwitterScreenState extends State<TwitterScreen> with
    AutomaticKeepAliveClientMixin<TwitterScreen>{
  late InAppWebViewController _webViewController;


  @override
  void didUpdateWidget(TwitterScreen oldWidget) {
